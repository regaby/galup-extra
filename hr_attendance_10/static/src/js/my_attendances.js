odoo.define('hr_attendance_10.my_attendances', function (require) {
"use strict";
...
var MyAttendances = Widget.extend({
    ...
    update_attendance: function () {
        var self = this;
        var hr_employee = new Model('hr.employee');
        hr_employee.call('attendance_manual', [[self.employee.id], 'hr_attendance_10.hr_attendance_action_my_attendances'])
