odoo.define('hr_attendance_10.kiosk_confirm', function (require) {
"use strict";
...
var KioskConfirm = Widget.extend({
    ...
    init: function (parent, action) {
        ...
        this.next_action = 'hr_attendance_10.hr_attendance_action_kiosk_mode';
    ...
    start: function () {
        var self = this;
        self.session.user_has_group('hr_attendance_10.group_hr_attendance_use_pin').then(function(has_group){
