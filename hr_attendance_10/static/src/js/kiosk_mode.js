odoo.define('hr_attendance_10.kiosk_mode', function (require) {
"use strict";
...
var KioskMode = Widget.extend(BarcodeHandlerMixin, {
    events: {
        "click .o_hr_attendance_button_employees": function(){ this.do_action('hr_attendance_10.hr_employee_attendance_action_kanban'); },
    },
